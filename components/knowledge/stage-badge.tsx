...
const STAGE_STYLE: Record<NutritiveStage, string> = {
  vegetative: "bg-[color-mix(in_srgb,var(--status-on-track)_16%,white)] text-[var(--status-on-track)]",
  "cross-over": "bg-[color-mix(in_srgb,var(--status-watch)_20%,white)] text-[var(--caution-text)]",
  reproductive: "bg-[color-mix(in_srgb,var(--status-needs-action)_18%,white)] text-[var(--status-needs-action-text)]",
  "all-stages": "bg-subtle-fill text-secondary",
  soil: "bg-[color-mix(in_srgb,#8a6d3b_16%,white)] text-[#6b5228]",
};
